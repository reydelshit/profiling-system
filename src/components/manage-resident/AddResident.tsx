...
export default function AddResident({
  ...
  const handleSubmitResidentDemo = (e: React.FormEvent<HTMLFormElement>) => {
    ...
    axios
      .post(`${import.meta.env.VITE_PRENATAL_LOCAL_HOST}/resident.php`, {
        ...residentDemogprahy,
  ...
  return (
    <div className="absolute w-full bg-slate-500 bg-opacity-75 h-fit py-[5rem] flex justify-center z-30">
      <form
